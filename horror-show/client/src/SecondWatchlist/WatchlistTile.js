    ...
    return (
        <div className="card">
            <div className="card-body">
                ...
                <h6 className='userWatchlist'>{}:<br /></h6>
                <div className="card-header">
                    <button className="btn watchlistTile-delete" ><Link to={"/watchlists/delete/"} className="navbar-textdecoration">Delete</Link></button>
                    <button className="btn watchlistTile-edit"><Link to={"/watchlists/edit/"} className="navbar-textdecoration">Edit</Link></button>
                </div>
